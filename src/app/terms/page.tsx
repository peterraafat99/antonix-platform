...
export const metadata: Metadata = { title: "Terms of Service", description: "Pre-launch terms for agency and platform services." };

export default function TermsPage() {
  return (
    <PublicPage>
      <main>
        <PageHero eyebrow="Legal" title="Terms of Service" description={`These pre-launch terms outline the expected rules for accessing ${brand.name}'s website, client workspace, and managed services.`} />
