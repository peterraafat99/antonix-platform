...
export default function PrivacyPage() {
  return (
    <PublicPage>
      <main>
        <PageHero eyebrow="Legal" title="Privacy Policy" description={`This policy describes how ${brand.name} collects, uses, protects, retains, and deletes information when delivering agency services and operating its client platform.`} />
